...
//This is the second bar chart in small multiples
//this graph uses the file AvgIT2.csv
    var margin = {top:50 , bottom: 100 , left: 100, right:50},
        ...
        svg.append("text")
            ...
            .attr("x", -50)
            .attr("y", -28)
            .text("Average Base Salary in IT");


        d3.csv("AvgIT2.csv").then(function(data){
            ...
            svg.append("text")
                ...
                .attr("x", -175)
                .attr("y", 400)
                .text("**Men make on average $546 more.");
