...
//NEED TO ADD LABELS
    ...
    var margin = {top:100 , bottom: 100 , left: 100, right:50},
        ...
        .attr("x", -140)
        .attr("y", 460)
        .text("**This chart shows that shows that hispanic and black women are impacted by the wage gap more than any other demographic. Black and Hispanic men are also more likely to be impacted by the wage gap.");
        ...
        svg.append("text")
            ...
            .attr("y", 495)
            .attr("fill", "purple")
            .text("Objective 4: What impact has COVID had on all of this?");
