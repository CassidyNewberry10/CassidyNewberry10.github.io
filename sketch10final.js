//GRAPH 10: total bonus in software dev
//third bar chart in second group of small multiples 
//uses the file BonusSd2.csv 
    var margin = {top:50 , bottom: 100 , left: 100, right:50},
        ...
        d3.csv("BonusSd2.csv").then(function(data){
            ...
            svg.append("text")
                ...
                .attr("x", -175)
                .attr("y", 400)
                .text("**This is a notable difference.");
